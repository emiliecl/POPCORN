...
<html>
	...
	<head>
		...
		<style>
			body{
				background: url("photos/har6.webp");
				color: black;
	...
	<center>
		...
		<!-- form: delete verification -->
		<div id="xsearch" class="home-search">
		<div class="search-content"> 
			<p>Do you want to delete this movie?</p>
			<form method="post" action="delete3.php" autocomplete="off">
				YES :  
				...
				<INPUT type="submit" value="Confirm" class="search1">
