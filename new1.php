...
<html>
	...
	<!-- form: in order to change the title of a movie -->
    <form action="new12.php" method="post" autocomplete="off">
		</br>
		<label for="title">Title</label>: 
		<input type="text" name="tit" placeholder="Add the new information"  required>
