...
<html>
	...
	<!-- form: in order to change the country of a movie -->
    <form action="new22.php" method="post" autocomplete="off">
		</br>
		<label for="contry">Country</label>: 
		<input type="text" name="contry" placeholder="Add the new information" value="" required>    
