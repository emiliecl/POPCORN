...
<html>
	...
	<!-- form: in order to change the category of a movie -->
    <form action="new42.php" method="post" autocomplete="off">
		</br> 
		<label for="caterory">Category</label>: 	
		<input type="text" name="caterory" placeholder="Add the new information" value="" required> 
